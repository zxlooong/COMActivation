...
/* Object interface: ITestObject, ver. 0.0,
   GUID={0x55A791C0,0x8805,0x4577,{0x9C,0x82,0x54,0x1C,0x52,0xA1,0xDC,0x06}} */
...
static const MIDL_SERVER_INFO ITestObject_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _ITestObjectProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* ITestObject::Test */
};
...
const CInterfaceProxyVtbl * _COM_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ITestObjectProxyVtbl,
    0
};

const CInterfaceStubVtbl * _COM_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ITestObjectStubVtbl,
    0
};
